...
import { useParams, queryParams, useLocation } from "react-router-dom";
...
const Productlist = () => {
  ...
  const routeChange = (id) => {
    if (id) {
      navigate(`/ProductOverview?pid=${id}`);
    }
  };
  ...
  return (
    <>
      ...
      <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
        {posts.map((item) => (
          <div class="rounded-lg border border-gray-200 bg-gray-50  p-6 shadow-sm dark:border-inheritbg-white" onClick={() => routeChange(item?.id)} >
            ...
            <div class="pt-6">
              <div class="mb-4 flex items-center justify-between gap-4">
                <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-sm font-medium text-primary-800 light:bg-primary-900 light:text-primary-600 text-black">
                  {item.brand}
                </span>
              ...
              <a
                href=""
                class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-black"
              ...
              <div class="mt-2 flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-gray-500 dark:text-black">
                  (455)
                </p>
              </div>
              ...
              <ul class="mt-2 flex items-center gap-4">
                <li class="flex items-center gap-2">
                  <svg
                    class="h-4 w-4 text-gray-500 dark:text-black"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <div class="mt-4 flex items-center justify-between gap-4">
                <p class="text-xl font-bold leading-tight text-gray-900 dark:text-black">
                  Rs.{item.price}
                </p>
