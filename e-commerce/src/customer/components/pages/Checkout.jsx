...
const Checkout = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:8080/cart/subtotal/${cartId}`, {
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/shipping/add/${cartId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
            'Authorization': `Bearer ${token}`
            ...
            <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
              <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                ...
                <div class="flex w-full flex-col px-4 py-4">
                  ...
                  <p class="text-lg font-bold">Rs.{item.pprice}</p>
                </div>
              </div>
            </div>
          ))}

          <p class="mt-8 text-lg font-medium">Payment Mode</p>
        ...
        <div class=" ">
          <div class="w-full max-w-3xl mx-auto p-8">
            <div class="bg-white p-8 rounded-lg shadow-md border ">
              ...
              <div class="mb-6">
                <h2 class="text-xl font-semibold text-gray-700 dark:text-black mb-2">
                  Shipping Address
                </h2>
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    <label
                      for="first_name"
                      class="block text-gray-700 dark:text-black mb-1"
                    >
                      First Name
                    </label>
                    <input
                      ...
                      id="first_name"
                      name="firstName"
                      class="w-full rounded-lg border py-2 px-3 dark:text-black dark:border-black"
          ...
          <div class="">
            ...
            <div class="mt-6 border-t border-b py-2">
              <div class="flex items-center justify-between">
                ...
                <p class="font-semibold text-gray-900">Rs.{total}.00</p>
              </div>
              <div class="flex items-center justify-between">
                <p class="text-sm font-medium text-gray-900">Shipping</p>
                <p class="font-semibold text-gray-900">00.0</p>
              </div>
            </div>
            <div class="mt-6 flex items-center justify-between">
              <p class="text-sm font-medium text-gray-900">Total</p>
              <p class="text-2xl font-semibold text-gray-900">Rs.{total}.00</p>
            </div>
          </div>
