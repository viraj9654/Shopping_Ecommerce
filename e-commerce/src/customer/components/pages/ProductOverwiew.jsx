...
const ProductOverwiew = () => {
  ...
  const Modal = ({ message, onClose }) => {
    ...
    return (
      <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"role="alert" onClick={onClose}>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
            ...
            <div class="data w-full lg:pr-8 pr-0 xl:justify-start justify-center flex items-center max-lg:pb-10 xl:my-2 lg:my-5 my-0">
              <div class="data w-full max-w-xl">
                ...
                Size <span> <Modal message={message} onClose={handleCloseModal}/></span>  
                </p>
                <div>
               
                </div>
                <div className="w-full pb-8 border-b border-gray-100 flex flex-col w-full space-y-8">
                  {product?.size?.length ? (
                    product.size.map((s, index) => (
                      <div className="grid grid-cols-1 min-[400px]:grid-cols-4 gap-3 max-w-md">
                        <button
                          ...
                          style={{
                            backgroundColor: size === s.name ? "blue" : "white",
                            cursor: "pointer",
                          }}
                        >
                          {s.name}
